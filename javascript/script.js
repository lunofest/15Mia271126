...
function updateTimer() {
  const targetDate = new Date("November 27, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543816357958'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543813653953'; // Número para el primer botón
  const recipientNumber2 = '543814187346'; // Número para el segundo botón
